-- HostOps Portal - Seed Data (Simplified)
-- This version works without needing email confirmation

-- First, check if profile exists, if not create it
DO $$
BEGIN
  IF NOT EXISTS (SELECT 1 FROM public.profiles WHERE id = 'c5a025d1-a2ec-4219-bed6-dd166ae77a57') THEN
...
DELETE FROM public.qr_codes WHERE listing_id IN ('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333');
DELETE FROM public.tasks WHERE listing_id IN ('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333');
DELETE FROM public.tv_devices WHERE listing_id IN ('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333');
DELETE FROM public.guests WHERE listing_id IN ('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333');
DELETE FROM public.listings WHERE id IN ('11111111-1111-1111-1111-111111111111', '22222222-2222-2222-2222-222222222222', '33333333-3333-3333-3333-333333333333');

-- Listing 1: Luxury Beach House
INSERT INTO public.listings (
  id, owner_id, name, description, address, image, active,
  bedrooms, bathrooms, guests, price, rating, reviews, tvs,
  amenities, carousel_images, background_image, tv_layout, language,
  wifi_network, wifi_password, contact_phone, contact_email,
  welcome_greeting, welcome_message, weather_city, weather_unit, website_url,
  show_check_in_out, standard_check_in_time, standard_check_out_time,
  show_wifi, show_contact, show_weather, show_qr_codes, show_logo, show_welcome_message, tours_link
) VALUES (
  ...
  'layout1', 'English', 'Beach House WiFi', 'welcome123',
  '+1 (305) 555-0123', 'contact@luxurybeach.com',
  'Welcome {{first-name}} {{last-name}}!',
  'We''re delighted to have you. Make yourselves at home and enjoy the serene views.',
  'Miami', 'F', 'https://luxurybeach.com',
  true, '16:00', '11:00', true, true, true, true, true, true, 'https://vi.me/GSCJL'
);
...
INSERT INTO public.listings (
  ...
  welcome_greeting, welcome_message, weather_city, weather_unit, website_url,
  show_check_in_out, standard_check_in_time, standard_check_out_time,
  show_wifi, show_contact, show_weather, show_qr_codes, show_logo, show_welcome_message
) VALUES (
  ...
  'layout2', 'English', 'Loft WiFi', 'loft2024',
  '+1 (212) 555-0456', 'info@downtownloft.com',
  'Welcome to Downtown Loft!', 'Enjoy your stay in the heart of the city.',
  'New York', 'F', 'https://downtownloft.com',
  true, '15:00', '11:00', true, true, true, true, true, true
);
...
INSERT INTO public.listings (
  ...
  bedrooms, bathrooms, guests, price, rating, reviews, tvs,
  amenities, carousel_images, background_image, tv_layout, language,
  contact_email, welcome_greeting, welcome_message, weather_unit, website_url,
  show_check_in_out, standard_check_in_time, standard_check_out_time,
  show_wifi, show_contact, show_weather, show_qr_codes, show_logo, show_welcome_message
) VALUES (
  ...
  'layout3', 'English', 'stay@mountaincabin.com',
  'Welcome to Mountain Cabin!', 'Relax and unwind in our cozy mountain retreat.',
  'F', 'https://mountaincabin.com',
  false, '16:00', '10:00', false, true, false, true, true, true
);
...
-- FAQs (delete and recreate to avoid duplicates)
DELETE FROM public.faqs WHERE category IN ('General', 'Billing', 'Integration');

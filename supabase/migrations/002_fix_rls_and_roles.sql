-- =====================================================
-- FIX RLS POLICIES AND ROLE CONSTRAINTS
-- =====================================================
-- This migration fixes the profile role constraint and RLS policies
-- to support super_admin, client roles and auto-profile creation

-- 1. DROP the old role constraint
ALTER TABLE public.profiles DROP CONSTRAINT IF EXISTS profiles_role_check;

-- 2. ADD new role constraint with three roles
ALTER TABLE public.profiles
  ADD CONSTRAINT profiles_role_check
  CHECK (role IN ('super_admin', 'admin', 'client'));

-- 3. DROP old profile policies
